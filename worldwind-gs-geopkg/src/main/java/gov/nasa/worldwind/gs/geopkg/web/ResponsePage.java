...
public class ResponsePage extends WebPage {
     ...
     *
     * @param model the demo request parameters holder, as a model for
     * {@link //DemoRequest}
     */
    public ResponsePage(final IModel model) {
        ...
        // Set the same markup is as in the html page so wicket does not generate
        // its own and the javascript code in the onLoad event for the <body>
        // element finds out the form by id
